...
pub extern "C" fn clone_syscall_entry(
    ...
    wasmtime_lind_multi_process::clone_syscall::<HostCtx, LindBootOptions>(
        cageid,
        clone_arg,
        clone_arg_cageid,
        parent_cageid,
...
pub extern "C" fn exec_syscall_entry(
    ...
    wasmtime_lind_multi_process::exec_syscall::<HostCtx, LindBootOptions>(
        cageid,
        path_arg,
        path_arg_cageid,
        argv,
...
pub extern "C" fn exit_syscall_entry(
    ...
    wasmtime_lind_multi_process::exit_syscall::<HostCtx, LindBootOptions>(
        cageid,
        exit_code,
        exit_code_cageid,
        arg2,
