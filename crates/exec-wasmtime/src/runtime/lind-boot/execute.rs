...
pub fn execute_wasmtime(lindboot_cli: LindBootOptions, workload: Workload) -> anyhow::Result<i32> {
...
pub fn precompile_module(cli: &LindBootOptions) -> Result<()> {
